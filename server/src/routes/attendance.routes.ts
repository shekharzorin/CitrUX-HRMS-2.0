...
router.get('/adjust/pending', authenticateToken, authorizeRole(['MANAGER', 'ADMIN', 'HR']), getPendingAdjustments);
router.post('/adjust/respond', authenticateToken, authorizeRole(['MANAGER', 'ADMIN', 'HR']), respondToAdjustment);
